 ...
 * \brief
 */
#ifndef INDEXER_COARSE_SCREEN_COMMON_H
#define INDEXER_COARSE_SCREEN_COMMON_H
using namespace AscendC;
namespace IndexerCoarseScreenCommon {
...
struct IndexerCoarseScreenType {
...
#endif // INDEXER_COARSE_SCREEN_COMMON_H
