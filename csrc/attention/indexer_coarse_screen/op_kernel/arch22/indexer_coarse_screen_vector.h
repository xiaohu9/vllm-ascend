...
/*!
 * \file indexer_coarse_screen_vector.h
 * \brief
 */
#ifndef INDEXER_COARSE_SCREEN_VECTOR_H
#define INDEXER_COARSE_SCREEN_VECTOR_H

#include "kernel_operator.h"

namespace IndexerCoarseScreenServiceVec {
                               ...
                               int64_t groupInner, int64_t s2Inner, int32_t outerGidx)
{
    ...
    AscendC::Brcb(tmpBuff, weightsUb, IndexerCoarseScreenCommon::CeilDiv(groupInner, static_cast<int64_t>(B32_BLOCK_ALIGN_NUM)),
...
#endif // INDEXER_COARSE_SCREEN_VECTOR_H
