...
/*!
 * \file indexer_refine_service_cube.h
 * \brief use 5 buffer for matmul l1, better pipeline
 */
#ifndef INDEXER_REFINE_SERVICE_CUBE_H
#define INDEXER_REFINE_SERVICE_CUBE_H
...
class IndexerRefineServiceCube {
public:
    ...
    __aicore__ inline void ComputeMm1(const IndexerRefineCommon::RunInfo &runInfo);
...
protected:
    __aicore__ inline void Fixp(uint64_t s1gGmOffset, uint64_t s2GmOffset, uint64_t s1gL0RealSize,
                                uint64_t s2L0RealSize, const IndexerRefineCommon::RunInfo &runInfo);
    __aicore__ inline void ComuteL0c(uint64_t s1gL0RealSize, uint64_t s2L0RealSize, const IndexerRefineCommon::RunInfo &runInfo);
...
template <typename LIT>
__aicore__ inline void IndexerRefineServiceCube<LIT>::InitParams(const ConstInfo &constInfo)
{
    constInfo_ = constInfo;
}

template <typename LIT>
__aicore__ inline void IndexerRefineServiceCube<LIT>::InitBuffers(TPipe *pipe)
{
...
template <typename LIT>
__aicore__ inline void IndexerRefineServiceCube<LIT>::ComputeMm1(const IndexerRefineCommon::RunInfo &runInfo)
{
...
// batch, s1, n2, g, d
template <typename LIT>
__aicore__ inline void IndexerRefineServiceCube<LIT>::QueryNd2Nz(uint64_t s1gL1RealSize, uint64_t s1gGmOffset,
                                                 const IndexerRefineCommon::RunInfo &runInfo)
{
    Nd2NzParams nd2nzPara;
    nd2nzPara.ndNum = 1;
...
template <typename LIT>
__aicore__ inline void IndexerRefineServiceCube<LIT>::LoadQueryToL0a(uint64_t s1gGmOffset,
...
template <typename LIT>
__aicore__ inline void IndexerRefineServiceCube<LIT>::LoadKeyToL0b(uint64_t s2L1Offset,
...
template <typename LIT>
__aicore__ inline void IndexerRefineServiceCube<LIT>::ComuteL0c(uint64_t s1gL0RealSize, uint64_t s2L0RealSize,
                                                const IndexerRefineCommon::RunInfo &runInfo)
{
...
template <typename LIT>
__aicore__ inline void IndexerRefineServiceCube<LIT>::Fixp(uint64_t s1gGmOffset,
...
template <typename LIT>
__aicore__ inline void IndexerRefineServiceCube<LIT>::AllocEventID()
{
...
template <typename LIT>
__aicore__ inline void IndexerRefineServiceCube<LIT>::FreeEventID()
{
