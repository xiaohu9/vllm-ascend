...
/*!
 * \file indexer_coarse_screen_template_tiling_key.h
 * \brief
 */

#ifndef TEMPLATE_TILING_KEY_CS_H_
#define TEMPLATE_TILING_KEY_CS_H_
...
// 模板参数支持的范围定义
ASCENDC_TPL_ARGS_DECL(IndexerCoarseScreen, // 算子OpType
...
// host 端 tiling key 硬编码只产生 TND query + PA_BSND key + PAGE_ATTENTION=1
// (tiling.cpp),BSND-query 与非 PA 组合永不选中,已从白名单裁剪(2026-09-23)。
ASCENDC_TPL_SEL(
