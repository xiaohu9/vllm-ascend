                               ...
                               int64_t groupInner, int64_t s2Inner, int32_t outerGidx)
{
    ...
    AscendC::Brcb(tmpBuff, weightsUb, IndexerRefineCommon::CeilDiv(groupInner, static_cast<int64_t>(B32_BLOCK_ALIGN_NUM)),
