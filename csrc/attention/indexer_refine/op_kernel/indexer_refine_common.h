...
/*!
 * \file indexer_refine_common.h
 * \brief
 */
#ifndef INDEXER_REFINE_COMMON_H
#define INDEXER_REFINE_COMMON_H
using namespace AscendC;
namespace IndexerRefineCommon {
